            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-5 mt-5 sm:mt-10">
                <div className="relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-between items-center py-4 md:px-5 px-3 bg-[#8888883a] rounded-b-md">
                        ...
                        <Link to='/books-category/Horror'><button className="bg-[#36ad68] py-2 px-3 sm:px-5 rounded-md text-white font-medium font-inter">See Books</button></Link>
                    </div>
                </div>
                <div className="relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-between items-center py-4 md:px-5 px-3 bg-[#8888883a] rounded-b-md">
                        ...
                        <Link to='/books-category/Fiction'><button className="bg-[#36ad68] py-2 px-3 sm:px-5 rounded-md text-white font-medium font-inter">See Books</button></Link>
                    </div>
                </div>
                <div className="relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-between items-center py-4 md:px-5 px-3 bg-[#8888883a] rounded-b-md">
                        ...
                        <Link to='/books-category/History'><button className="bg-[#36ad68] py-2 px-3 sm:px-5 rounded-md text-white font-medium font-inter">See Books</button></Link>
                    </div>
                </div>
                <div className="relative">
                    ...
                    <div className="absolute bottom-0 w-full flex justify-between items-center py-4 md:px-5 px-3 bg-[#8888883a] rounded-b-md">
                        ...
                        <Link to='/books-category/Biography'><button className="bg-[#36ad68] py-2 px-3 sm:px-5 rounded-md text-white font-medium font-inter">See Books</button></Link>
                    </div>
                </div>
            </div>
        </div>
