...
const Navbar = () => {
    ...
    return (
        <div className={`fixed w-full transition-all duration-500 ease-in-out ${scrollY > 5 ? 'top-0 bg-gradient-to-r opacity-100 from-[#ebf6fe] to-[#a1d8fe]' : 'top-6 opacity-0'} left-1/2 -translate-x-1/2 z-30`}>
